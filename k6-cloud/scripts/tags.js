...
export default function() {
    ...
    const respCreateCrocodile = session.post('/my/crocodiles/', payload, crocs_params);
    ...
    const respDeleteCrocodile = session.delete(`/my/crocodiles/${crocId}`, undefined, crocs_params)
